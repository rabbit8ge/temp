...
public class SlideSwitch extends View {
	...
	protected void onDraw(Canvas canvas) {
		if (shape == SHAPE_RECT) {
			...
			frontRect = new Rect(frontRect_left, RIM_SIZE, frontRect_left + getMeasuredWidth() / 2 - RIM_SIZE,
			...
			frontRect = new Rect(frontRect_left, RIM_SIZE, frontRect_left + backRect.height() - 2 * RIM_SIZE,
