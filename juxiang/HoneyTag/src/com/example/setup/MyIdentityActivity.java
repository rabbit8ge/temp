...
public class MyIdentityActivity extends BaseActivity {
	...
	public void loadData() {
		...
		mRelNavigationView.setClickCallback(new ClickCallback() {
			...
			public void onBackClick() {
				MyApplication.getInstance().popActivity(MyIdentityActivity.this);
	...
	public void onClick(View v) {
		...
		case R.id.tv_level:// 我的等级
			startActivity(new Intent(MyIdentityActivity.this, MyGradesActivity.class));
			break;
		case R.id.tv_identity:// 我的身份

			startActivity(new Intent(MyIdentityActivity.this, IdentityActivity.class));
