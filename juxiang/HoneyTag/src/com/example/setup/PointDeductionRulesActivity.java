...
public class PointDeductionRulesActivity extends BaseActivity {
	...
	public void loadXml() {
		...
		setContentView(R.layout.activity_point_deduction_rules);
		mRelNavigationView = (NavigationView) findViewById(R.id.navigationView);
		mRelNavigationView.setTitle(getString(R.string.koufen_guize));
	...
	public void loadData() {
		...
		mRelNavigationView.setClickCallback(new ClickCallback() {
			...
			public void onBackClick() {
				MyApplication.getInstance().popActivity(PointDeductionRulesActivity.this);
